...
export default function Footer() {
  return (
    <footer className="bg-slate-950 text-slate-400 text-sm border-t border-slate-900 pt-16 pb-8 px-6 md:px-12 w-full selection:bg-cyan-500/35 relative z-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
        ...
        <div className="md:col-span-5 space-y-4">
          <Link 
            to="/" 
            className="group text-2xl font-black tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-teal-400 to-blue-500 inline-flex items-center gap-1"
          >
          ...
          <div className="flex items-center gap-3 pt-2">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-cyan-400 hover:border-cyan-500/50 text-xs font-semibold transition-all shadow-sm hover:-translate-y-0.5"
            >
        ...
        <div className="md:col-span-5 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-1">
            ...
            <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-950 font-bold rounded-xl text-sm transition-all hover:from-cyan-400 hover:to-blue-500 tracking-wide whitespace-nowrap shadow-lg shadow-cyan-500/20 hover:-translate-y-0.5">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
        <p className="text-center sm:text-left flex items-center justify-center sm:justify-start gap-1">
          &copy; 2026 Muhammad Ahmad. Crafted with <Heart size={12} className="text-cyan-400 fill-cyan-400 animate-pulse" /> All rights reserved.
        </p>
