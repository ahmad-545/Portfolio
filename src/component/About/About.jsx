      ...
      <main className="flex-grow py-16 px-6 md:px-12 max-w-6xl mx-auto w-full relative z-10 selection:bg-cyan-500/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            {/* Bio */}
            <p className="text-slate-300 text-lg font-light leading-8 text-left">
              I am a passionate MERN Stack Developer dedicated to building
              efficient, scale-ready web applications. I specialize in
              crafting rich user interfaces with React, managing database
              state with MongoDB, and engineering robust backend systems
              utilizing Node.js and Express. From creating smooth interactive
              designs to deploying server logic, I focus on building
              ...
              {skillsData.map((skill, index) => (
                <div key={index} className="space-y-2 group">
                  ...
                  <div className="w-full bg-slate-900 h-2 rounded-full overflow-hidden border border-slate-800/50">
                    ...
                    <div
                      className={`h-full bg-gradient-to-r ${skill.color} ${skill.width} rounded-full transition-all duration-500`}
                    ></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-slate-900/40 backdrop-blur-sm border border-slate-900 rounded-2xl p-8 text-center shadow-xl">
          ...
          {stats.map((stat, idx) => (
            ...
            <div
              key={idx}
              className="space-y-2 relative group py-4 sm:py-0 last:border-none border-b sm:border-b-0 sm:border-r border-slate-800/60"
            >
